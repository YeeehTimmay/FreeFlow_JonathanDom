...
public class Board {
    ...
    //creates a raster with a double array. The size of the array is the same as the size of your board, and it is filled with Empty fields.
    ...
    //calls on a field and checks if it is within the board bounds. Else throws an error.
    ...
    //checks if there are empty fields still on the board. Returns true if there are, false if the board is full.
