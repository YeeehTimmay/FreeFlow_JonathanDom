        ...
        switch (direction) {
            case NORTH:
                ...
                if (board.getField(x, y + 1).getType() != Type.VERTICAL) {
                    if (board.getField(x, y + 1).getType() != Type.CIRCLE && board.getField(x, y + 1).getType() != Type.EMPTY)
                        board.setField(x, y + 1, Type.CORNER, board.getField(x, y + 1).getColor());
                    else if (board.getField(x,y + 1).getColor() == board.getField(x,y).getColor())
                        completedColor +=1;
            ...
            case EAST:
                ...
                if (board.getField(x - 1, y).getType() != Type.HORIZONTAL) {
                    if (board.getField(x - 1, y).getType() != Type.CIRCLE && board.getField(x - 1, y).getType() != Type.EMPTY)
                        board.setField(x - 1, y, Type.CORNER, board.getField(x - 1, y).getColor());
                    else if (board.getField(x - 1,y ).getColor() == board.getField(x,y).getColor())
                        completedColor +=1;
